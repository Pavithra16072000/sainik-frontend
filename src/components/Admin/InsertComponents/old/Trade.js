...
const Trade = () => {
    ...
    return (
      ...
      <div id="formContent">
        ...
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Service_Id"value={Service_Id} onChange={(e) => setService_Id(e.target.value)} />
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Group_Name"value={Group_Name} onChange={(e) => setGroup_Name(e.target.value)} />
