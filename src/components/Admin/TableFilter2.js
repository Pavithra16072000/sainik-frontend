...
const [userList, setUserList] = useState([]);
   ...
   useEffect(() => {
    ...
    const columns = [
      ...
      {dataField: 'vService', text: 'Service Name' , sort: true , filter: textFilter()},
      ...
      {dataField: 'vRank', text: 'Rank Name', sort: true , filter: textFilter()},
...
// Form2
      ...
      {dataField: 'vDischarge_Date', text: 'Discharge Date',hidden : hideDD, sort: true , filter: dateFilter()},
...
// Form3
            ...
            {dataField: 'vBirth_Dist_Surname', text: 'Birth District',hidden : hideBD, sort: true , filter: textFilter()},
            {dataField: 'vBirth_Place', text: 'Birth Place',hidden : hideBPL, sort: true , filter: textFilter()},
            {dataField: 'vReligion', text: 'Religion',hidden : hideReligion, sort: true , filter: textFilter()},
            {dataField: 'vCaste_Category', text: 'Caste Category',hidden : hideCC, sort: true , filter: textFilter()},
...
// Form4
            ...
            {dataField: 'vState', text: 'Present State',hidden : hidePRS, sort: true , filter: textFilter()},
            {dataField: 'vDistrict', text: 'Present District',hidden : hidePD, sort: true , filter: textFilter()},
            {dataField: 'vTaluk_Name', text: 'Present Taluk',hidden : hidePT, sort: true , filter: textFilter()},
