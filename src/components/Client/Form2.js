...
import FormLabel, {StarLabel, FormLabel2} from "../../view/FormLabel";
       ...
       {/*<label htmlFor =""> From  {minDate} To {maxDate} </label><br/>*/}
        ...
        <option value = "" disabled selected >--Select One--</option>
         ...
         <option key={user.id}value={user.Value}>{user.Value}</option>
          ...
          <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio"  id="inlineRadio2" name="If_Pensioner" value="No"  onClick={checkPension} onChange={(e) => setIf_Pensioner(e.target.value)} />
         ...
         {/*  <FormLabel2 text={"Whether sanctioned disability Pension"} />*/}
          ...
          <div className="col-lg-4 space">
          <input type="text"  class="  formInput" autocomplete = "off" maxlength= "6" minlength="3" name="Disability_Pension" value={Disability_Pension} onChange={onDisabilityChange} /><br/>
