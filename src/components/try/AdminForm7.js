    ...
    (() => {
        if(ad == "Clerk") {
                return (
                  <div>
                  <div className="text-center text-dark p-3 foot" style={{backgroundColor: "#DBE6FD"}}>
                  <button id="verified"className="btn my-2 my-sm-0 right-align " type="submit">Verify </button>
                  </div>
                  </div>
                )
            } else if (ad == "SuperIndendent") {
                return (
                  <div>
                  <form onClick={Recommend}>
                  <div className="text-center text-dark p-3 foot" style={{backgroundColor: "#DBE6FD"}}>
                  <button id="verified"className="btn my-2 my-sm-0 right-align "  type="submit">Recommend </button>
                  </div>
                  </form>
                  </div>
                )
