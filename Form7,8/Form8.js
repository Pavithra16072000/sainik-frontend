...
const onAdhaarChange = (e) =>  {
 ...
 navigate("/Form7");
    ...
    <FormLabel text={"Dependent Name"} />
         ...
         <input type="text"  class="fadeIn second formInput" name="Dep_Name" value={Dep_Name}onChange={(e) => setDep_Name(user.Dep_Name)}required />
         </div>
...
<div className="form-check form-check-inline">
     <input className="form-check-input" type="radio"  id="inlineRadio1" name="Dep_Employment_Status"  value="Employed" onChange={(e) => setDep_Employment_Status(e.target.value)} />
     <label className="form-check-label" for="inlineRadio1">Employed</label>
     </div>

     <div className="form-check form-check-inline">
     <input className="form-check-input" type="radio" id="inlineRadio2" name="Dep_Employment_Status"  value="UnEmployed" onChange={(e) => setDep_Employment_Status(e.target.value)} />
